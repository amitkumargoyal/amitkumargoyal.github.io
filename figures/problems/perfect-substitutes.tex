...
\tikzset{
  indiff/.style={violet, very thick},                     % indifference curve
  budget/.style={terracotta, very thick},                 % budget line
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[indiff, opacity=0.30, domain=0:2] {1   - 0.5*x}
      node[pos=0.5, above right=-1pt, font=\scriptsize, text=inksoft, opacity=1] {$u=2$};
    \addplot[indiff, opacity=0.55, domain=0:5] {2.5 - 0.5*x};
    \addplot[indiff, domain=0:8] {4 - 0.5*x}
      node[pos=0.66, above right=-1pt, font=\scriptsize, text=violet] {$u=8$};
    ...
    \node[font=\scriptsize, anchor=west, text=ink]
